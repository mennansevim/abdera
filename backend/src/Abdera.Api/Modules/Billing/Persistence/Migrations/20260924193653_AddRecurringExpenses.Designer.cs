...
namespace Abdera.Api.Modules.Billing.Persistence.Migrations
{
    ...
    [Migration("20260924193653_AddRecurringExpenses")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abdera.Api.Modules.Billing.Domain.RecurringExpense", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Abdera.Api.Modules.Billing.Domain.RecurringExpenseAmount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("recurring_expense_amounts", null, t =>
                        {
            ...
            modelBuilder.Entity("Abdera.Api.Modules.Messaging.Domain.NotificationAutomationSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("AllowAttendingLateResponse")
                        .HasColumnType("boolean")
                        .HasColumnName("allow_attending_late_response");

                    b.Property<bool>("IsEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("is_enabled");

                    b.Property<int>("LessonReminderMinutesBefore")
                        .HasColumnType("integer")
                        .HasColumnName("lesson_reminder_minutes_before");
                    ...
                    b.ToTable("notification_automation_settings", (string)null);
                });
            ...
            modelBuilder.Entity("Abdera.Api.Modules.Messaging.Domain.StaffNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Abdera.Api.Modules.Ops.Domain.BackupRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("TriggeredManually")
                        .HasColumnType("boolean")
                        .HasColumnName("triggered_manually");
            ...
            modelBuilder.Entity("Abdera.Api.Modules.Ops.Domain.SystemHealthStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("LastAlertSentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_alert_sent_at");
                    ...
                    b.ToTable("system_health_status", (string)null);
                });
            ...
            modelBuilder.Entity("Abdera.Api.Modules.People.Domain.GuardianLoginCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("guardian_login_codes", (string)null);
                });
            ...
            modelBuilder.Entity("Abdera.Api.Modules.People.Domain.Student", b =>
                {
                    ...
                    b.Property<bool>("SiblingDiscount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("sibling_discount");
            ...
            modelBuilder.Entity("Abdera.Api.Modules.People.Domain.StudentDeletionRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("student_deletion_requests", (string)null);
                });
            ...
            modelBuilder.Entity("Abdera.Api.Modules.Billing.Domain.RecurringExpenseAmount", b =>
                {
                    b.HasOne("Abdera.Api.Modules.Billing.Domain.RecurringExpense", null)
                        .WithMany("Amounts")
