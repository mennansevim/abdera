...
| K3 | Ders taşıma/iptal | **Değişmedi.** Var olan bir dersi taşımak/iptal etmek ve telafi yerleştirmek hâlâ yalnızca Admin; öğretmen `LessonChangeRequest` açar. Gerekçe: seri kurmak ileriye dönük bir plan, tek dersi oynatmak ise veliye bildirim gitmiş bir taahhüdü bozmaktır. |
